                ...
                <div className="flex justify-center items-start animate-fade-in-down w-full h-auto my-4 bg-gradient-to-l from-[#0f2527] via-[#203A43] to-[#2C5364] text-white ">
                    <div className="mx-2 my-4 flex gap-5 flex-col text-justify text-gray-200/80">
                        <p className="font-sans text-lg">
                            ...
                            collected and recorded by imgpalace and how we use it.
                        </p>
                        <p className="font-sans text-lg ">
                        ...
                        <p className="font-sans text-lg  ">
                            ...
                            that they shared and/or collect in imgpalace. This policy is not
                            applicable to any information collected offline or via channels
                            other than this website.
                        </p>

                        <h2 className="text-center my-4 text-white">Consent</h2>
                        <p>
                            By using our website, you hereby consent to our Privacy Policy and
                            agree to its terms.
                        </p>

                        <h2 className="text-center my-4 text-white">Information we collect</h2>
                        <p>
                        ...
                        <h2 className="text-center my-4 text-white">How we use your information</h2>
                        <p>
                            We use the information we collect in various ways, including to:
                        </p>
                        <ul className="list-disc mx-5 leading-relaxed -space-y-3 list-inside">
                        ...
                        <h2 className="text-center my-4 text-white ">Log Files</h2>
                        <p className="text-left leading-relaxed">
                            imgpalace follows a standard procedure of using log files. These
                        ...
                        <h2 className="text-center my-4 text-white">Google DoubleClick DART Cookie</h2>
                        <p className="text-left leading-relaxed">
                            Google is one of a third-party vendor on our site. It also uses
                            cookies, known as DART cookies, to serve ads to our site visitors
                            based upon their visit to www.imgpalace.legiondev.net and other
                        ...
                        <h2 className="text-center my-4 text-white">Our Advertising Partners</h2>
                        <p className="text-left leading-relaxed">
                        ...
                        <p className="text-left leading-relaxed">
                            ...
                            the advertising partners of imgpalace.
                        </p>
                        <p className="text-left leading-relaxed">
                            Third-party ad servers or ad networks uses technologies like
                            cookies, JavaScript, or Web Beacons that are used in their
                            respective advertisements and links that appear on imgpalace,
                        ...
                        <p className="text-left leading-relaxed">
                            Note that imgpalace has no access to or control over these cookies
                            that are used by third-party advertisers.
                        </p>

                        <h2 className="text-center my-4 text-white">Third Party Privacy Policies</h2>
                        <p className="text-left leading-relaxed">
                            imgpalace's Privacy Policy does not apply to other advertisers or
                        ...
                        <h2 className="text-center my-4 text-white">GDPR Data Protection Rights</h2>
                        ...
                        <h2 className="text-center my-4 text-white">Children's Information</h2>
                        ...
                        <p className="text-left leading-relaxed ">
                            imgpalace does not knowingly collect any Personal Identifiable
