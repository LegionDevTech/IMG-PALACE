        ...
        <>
            ...
            <div className="max-w-none px-4 py-4 mx-auto bg-gradient-to-l from-[#0f2527] via-[#203A43] to-[#2C5364]">
                ...
                <div className="flex justify-center items-center py-4 border-x-2 hover:border-pink-500 hover:border-shadow-2xl shadow-xl rounded-md bg-gradient-to-l from-[#0f2527]  to-[#2C5364] text-white">
                    <h2> Terms &amp; Conditions | .IMG PALACE </h2>
                </div>
                <div className="flex justify-center items-start animate-fade-in-down w-full h-auto my-4 bg-gradient-to-l from-[#0f2527] via-[#203A43] to-[#2C5364] text-white ">
                    <div className="mx-2 my-4 flex gap-5 flex-col text-justify">

                        <p className="text-center my-4 text-lg">Welcome to imgpalace!</p>

                        <p className="text-left leading-relaxed text-gray-200/80">
                            These terms and conditions outline the rules and regulations for
                            the use of imgpalace's Website, located at
                            https://imgpalace.legiondev.net/.
                        </p>

                        <p className="text-left leading-relaxed text-gray-200/80">
                            By accessing this website we assume you accept these terms and
                            conditions. Do not continue to use imgpalace if you do not agree
                        ...
                        <p className="text-left leading-relaxed text-gray-200/80">
                            We employ the use of cookies. By accessing imgpalace, you agreed
                            to use cookies in agreement with the imgpalace's Privacy Policy.{" "}
                        </p>
                        ...
                        <p className="text-left leading-relaxed text-gray-200/80">
                            Unless otherwise stated, imgpalace and/or its licensors own the
                            intellectual property rights for all material on imgpalace. All
                            intellectual property rights are reserved. You may access this
                            from imgpalace for your own personal use subjected to restrictions
                            set in these terms and conditions.
                        </p>

                        <p className="text-left leading-relaxed text-gray-200/80">You must not:</p>
                        <ul className="list-disc mx-5 leading-relaxed -space-y-3 list-inside text-gray-200/80">
                            <li>Republish material from imgpalace</li>
                            <li>Sell, rent or sub-license material from imgpalace</li>
                            <li>Reproduce, duplicate or copy material from imgpalace</li>
                            <li>Redistribute content from imgpalace</li>
                        </ul>

                        <p className="text-left leading-relaxed text-gray-200/80">This Agreement shall begin on the date hereof.</p>

                        <p className="text-left leading-relaxed text-gray-200/80">
                            Parts of this website offer an opportunity for users to post and
                            exchange opinions and information in certain areas of the website.
                            imgpalace does not filter, edit, publish or review Comments prior
                            to their presence on the website. Comments do not reflect the
                            views and opinions of imgpalace,its agents and/or affiliates.
                            ...
                            laws, imgpalace shall not be liable for the Comments or for any
                        ...
                        <p className="text-left leading-relaxed text-gray-200/80">
                            imgpalace reserves the right to monitor all Comments and to remove
                            any Comments which can be considered inappropriate, offensive or
                            causes breach of these Terms and Conditions.
                        </p>

                        <p className="text-left leading-relaxed text-gray-200/80">You warrant and represent that:</p>
                        ...
                        <p className="text-left leading-relaxed text-gray-200/80">
                            You hereby grant imgpalace a non-exclusive license to use,
                        ...
                        <p className="text-left leading-relaxed text-gray-200/80">
                            ...
                            imgpalace; and (d) the link is in the context of general resource
                            information.
                        </p>
                        ...
                        <p className="text-left leading-relaxed text-gray-200/80">
                            ...
                            by sending an e-mail to imgpalace. Please include your name, your
                        ...
                        <p className="text-left leading-relaxed text-gray-200/80">
                            No use of imgpalace's logo or other artwork will be allowed for
                        ...
                        <p className="text-left leading-relaxed text-gray-200/80">Please read Privacy Policy</p>
